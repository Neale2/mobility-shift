"""
Django settings for mobilityshift project.
...
ALLOWED_HOSTS = ["app.swapone.nz", "127.0.0.1", "localhost"]
...
ROOT_URLCONF = 'mobilityshift.urls'
...
WSGI_APPLICATION = 'mobilityshift.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_ROOT = "/var/www/mobilityshift/staticfiles"
